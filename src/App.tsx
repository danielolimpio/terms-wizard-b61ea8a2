...
import DireitosTitularLGPDPost from "./pages/blog/DireitosTitularLGPDPost";
    ...
    <HelmetProvider>
      <QueryClientProvider client={queryClient}>
        <TooltipProvider>
          ...
          <Route path="/blog/direitos-titular-lgpd-guia-completo" element={<DireitosTitularLGPDPost />} />
