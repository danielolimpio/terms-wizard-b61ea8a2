...
const AccessibilityPolicyInfoPage = () => {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            <div className="space-y-6">
              <Card>
                ...
                <CardContent>
                  <Button className="w-full" onClick={() => setShowGenerator(true)}>Gerar Política de Acessibilidade</Button>
                </CardContent>
              </Card>
...
export default AccessibilityPolicyInfoPage;