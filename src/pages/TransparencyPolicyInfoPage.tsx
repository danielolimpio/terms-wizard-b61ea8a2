...
export default function TransparencyPolicyInfoPage() {
  return (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            <Card className="lg:col-span-2">
              ...
              <CardContent className="space-y-6 text-muted-foreground leading-relaxed">
                <p>
                  Uma Política de Transparência é um documento que demonstra o compromisso de uma organização com práticas éticas, abertas e responsáveis em suas operações. Este documento vai além das obrigações legais mínimas, mostrando voluntariamente como a empresa opera, toma decisões e se relaciona com stakeholders.
                </p>
